...
export class DietsCalcultorComponent implements OnInit {
  ...
  onCalculate(){
    this.BMI = (this.dietCredential.weight) / (this.dietCredential.height * this.dietCredential.height);
    this.weight =(0.5 * this.BMI + 11.5) * this.dietCredential.height * this.dietCredential.height;
